 ...
 * dev database (platoo_cart) is never touched by the test suites.
 *
 * SAFETY GUARD: refuses to run if the resolved MONGO_URI database name does
 * not end in "_test". This is a hard stop, not a warning.
 */
const fs = require('fs');
...
const TEST_MONGO_URI =
  ...
  'mongodb://127.0.0.1:27017/platoo_cart_test';
